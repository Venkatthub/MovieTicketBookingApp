...
public class ShowSeatsAvailabilityController {
	...
	@GetMapping(value = "/screen-a/available-seats", produces = "application/json")
	...
	@GetMapping(value = "/screen-b/available-seats", produces = "application/json")
	...
	@GetMapping(value = "/screen-c/available-seats", produces = "application/json")
	...
	@GetMapping(value = "/screen-d/available-seats", produces = "application/json")
